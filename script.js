document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
      ...
      if (value !== '') {
        if (type === 'email' || name.indexOf('email') !== -1) {
          ...
          if (value.length < field.minLength) {
            showFieldError(field, field.dataset.errorMinlength || 'This field is too short.');
            isValid = false;
          }
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (allValid) {
        ...
        var successMessage = contactForm.querySelector('.form-success-message');
        if (!successMessage) {
  ...
  if (animatedElements.length > 0) {
    ...
    style.textContent = [
      '.animate-ready { opacity: 0; transition: opacity 0.6s ease, transform 0.6s ease; }',
      '.fade-in-up.animate-ready { transform: translateY(30px); }',
      '.fade-in-down.animate-ready { transform: translateY(-30px); }',
      '.fade-in-left.animate-ready { transform: translateX(30px); }',
      '.fade-in-right.animate-ready { transform: translateX(-30px); }',
    ...
    function handleScrollAnimations() {
      animatedElements.forEach(function (el) {
        if (!el.classList.contains('animate-visible') && isElementInViewport(el)) {
    ...
    var animationScrollTicking = false;
    window.addEventListener('scroll', function () {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8bb2419f-cd28-40ee-8080-9d52b4e6e869',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8bb2419f-cd28-40ee-8080-9d52b4e6e869';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8bb2419f-cd28-40ee-8080-9d52b4e6e869';
